...
function usage(): string {
  return [
    ...
    '      supervisor service exists on this machine, claim the install, and',
    '      report ● online / ⏸ waiting for an admin / ○ registered — not',
    '      serving. Idempotent and resumable from any partial state; writes',
    '      NOTHING inside the department folder (no cloud.json — a department',
    '      is clonable and must not be pinned to one org). Exit 0 online or',
