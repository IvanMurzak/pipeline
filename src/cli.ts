...
function usage(): string {
  return [
    ...
    '      ./.pipelines/<name>/ (relative to the current directory, or',
    ...
    '      tokens) recorded under <project>/.pipelines/.stats/ by the',
    ...
    '      .pipelines/cloud.json (slugs + URL only — safe to commit; the',
    ...
    '      + one skill from an EXISTING ./.pipelines/<name>/PIPELINE.md',
