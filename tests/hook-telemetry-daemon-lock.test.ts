/**
 * The telemetry-daemon-ensure block in src/hooks/analytics-relay.ts (ux-v2 b11):
 ...
 * tests/credential-lock.test.ts (the other `wx`
 ...
 *     `child.unref()`) is copied verbatim from `department-notifier-relay.ts`'s
 ...
 * write shape (`department-notifier-relay.ts`'s own buggy shape) and the
...
} from "../src/hooks/analytics-relay.ts";
