/**
 * PreToolUse mirror-binding writer — src/hooks/analytics-relay.ts (Phase 2).
 *
 ...
 *  canonical UUID's third dash-group). Mirrors the CLI package's
...
describe("bypassRunIdFromToolUseId", () => {
  ...
  // UUIDv5 over tool_use_id, src/lib/ids.ts) instead of a
