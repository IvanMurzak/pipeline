 ...
 *
 * `bypassRunIdFromToolUseId` (src/hooks/analytics-relay.ts) exists BECAUSE
 ...
 * memory (the ":1028" rationale in analytics-relay.ts). A regression that
...
const HOOKS_FILE = resolve(import.meta.dir, "..", "src", "hooks", "analytics-relay.ts");
