...
// `department-notifier-relay.ts` this task is fixing manifests ACROSS TWO
...
// (`src/hooks/analytics-relay.ts`'s `spawnTelemetryDaemon` comment: a hook that
...
import { acquireTelemetryDaemonLock } from '../../src/hooks/analytics-relay.ts';
